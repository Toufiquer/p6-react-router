  ...
  return (
    <div className="border-2 border-b-gray-600 p-4 bg-blue-400">
      ...
      <div className="flex justify-between mt-2 gap-2">
        <button onClick={() => handleAddToCart(id)} className="hover:bg-green-600 bg-green-400 p-2 px-4 w-full">
          Add{" "}
        </button>
        <button onClick={() => handleRemoveFromCart(id)} className="hover:bg-red-600 bg-red-400 p-2 px-4 w-full">
          Remove{" "}
        </button>
      </div>
    </div>
